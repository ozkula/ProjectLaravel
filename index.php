  ...
  <body> 
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image:url(images/bg_1.jpg);">
    	...
    	<section class="ftco-services ftco-no-pb">
			<div class="container">
				<div class="row ">
					<div class="col-md-4 d-flex services  p-4 ftco-animate">
						<div class="media text-center">
						<div class="icon d-flex justify-content-center align-items-center">
								<span class="flaticon-ambulance"></span>
						</div>
						<div class="media-body p-2 mt-3">
							<h3 class="heading">Jadwal Dokter</h3>
						</div>
						</div>    
					</div>
					<div class="col-md-4 d-flex services  p-4 ftco-animate">
						...
						<div class="media-body p-2 mt-3">
							<h3 class="heading">Ketersediaan Kamar</h3>
						</div>
						</div>      
					</div>
					<div class="col-md-4 d-flex services  p-4 ftco-animate">
						...
						<div class="media-body p-2 mt-3">
							<h3 class="heading">Ketersediaan Darah</h3>
						</div>
						</div>      
					</div>
				</div>
			...
			<div class="container">
	          ...
	          <div class="heading-section mb-5">
	          	<div class="pl-md-5 ml-md-5">
		            <h2 class="mb-4" style="font-size: 28px;">Kami siap melayani anda</h2>
	            </div>
	          </div>
    ...
    <section class="ftco-section">
    	<div class="container">
            ...
            <h2 class="mb-4">Layanan Unggulan</h2>
			<section class="ftco-services ftco-no-pb mt-5">
				<div class="container">
					<div class="row ">
						<div class="col-md-6 d-flex services p-4 ftco-animate">
							<div class="media text-center">
							<div class="icon d-flex justify-content-center align-items-center">
									<span class="flaticon-ambulance"></span>
							</div>
							<div class="media-body p-2 mt-3">
								<h3 class="heading">Trauma Center</h3>
							</div>
							</div>    
						</div>
						<div class="col-md-6 d-flex services p-4 ftco-animate">
        ...
        <div class="row">
					<div class="col-md-12 text-center">
							<h2 class="mb-4 mt-5">Pelayanan Medis</h2>
					</div>
				</div>
				...
				<div class="row">
		          ...
		          <div class="col-md-4 d-flex justify-content-center ftco-animate fadeInUp ftco-animated">
		          ...
		          <div class="col-md-4 d-flex justify-content-center ftco-animate fadeInUp ftco-animated">
		            <div class="p-5 bg-light">
		              <div class="text">
		                ...
		                <span>Endoskopi & Gastrokopi</span>
		              </div>
		            </div>
		          </div>
		          <div class="col-md-4 d-flex justify-content-center ftco-animate fadeInUp ftco-animated">
				...
				<div class="row">
					<div class="col-md-12 text-center">
							<h2 class="mb-4 mt-5">Pelayanan Penunjang Medis</h2>		
					</div>
				</div>
				...
				<div class="row">
		          ...
		          <div class="col-md-3 d-flex justify-content-center ftco-animate fadeInUp ftco-animated">
		            <div class="p-5 bg-light">
		              <div class="text">
		                <div class="icon d-flex justify-content-center align-items-center">
												<span class="flaticon-ambulance"></span>
